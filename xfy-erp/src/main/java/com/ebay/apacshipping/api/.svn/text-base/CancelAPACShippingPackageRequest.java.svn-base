...
/**
 * <p>CancelAPACShippingPackageRequest complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="CancelAPACShippingPackageRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CancelAPACShippingPackageRequest", propOrder = {
    "trackCode"
})
public class CancelAPACShippingPackageRequest
    extends BaseRequest
{
