...
/**
 * <p>RecreateAPACShippingPackageResponse complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="RecreateAPACShippingPackageResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "RecreateAPACShippingPackageResponse", propOrder = {
    "trackCode"
})
public class RecreateAPACShippingPackageResponse2
