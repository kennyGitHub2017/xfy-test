 ...
 * 2015-04-21T09:24:23.411+08:00
 * Generated source version: 3.0.4
 * 
 */
public final class ApacShippingServiceSoap_ApacShippingServiceSoap12_Client {
	private static final Logger logger = LoggerFactory
			.getLogger(ApacShippingServiceSoap_ApacShippingServiceSoap12_Client.class);
    private static final QName SERVICE_NAME = new QName("http://api.apacshipping.ebay.com/", "ApacShippingService");

    private ApacShippingServiceSoap_ApacShippingServiceSoap12_Client() {
    }
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        ApacShippingServiceSoap port = ss.getApacShippingServiceSoap12();  
