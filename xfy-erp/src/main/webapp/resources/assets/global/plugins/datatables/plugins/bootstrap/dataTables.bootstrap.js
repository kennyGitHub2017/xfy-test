...
$.extend(true, $.fn.dataTable.defaults, {
    ...
    "dom": "<'row'<'col-md-6 col-sm-12'li><'col-md-6 col-sm-12'f>r>t<'row'<'col-md-5 col-sm-12'li><'col-md-7 col-sm-12'p>>", // datatable layout without  horizobtal scroll(used when bootstrap dropdowns used in the datatable cells)
    "language": {
