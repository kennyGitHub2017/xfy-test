...
<tiles:insertDefinition name="metronicTemplate">
	<tiles:putAttribute name="title">测试页面：两列，带有宽度固定左侧导航</tiles:putAttribute>
										...
										<div class="scroller" style="max-height: 800px;" data-always-visible="0" data-rail-visible="0" data-handle-color="#dae3e7">
											<div class="todo-tasklist">
												<div class="todo-tasklist-item todo-tasklist-item-border-green">
													<img class="todo-userpic pull-left" src="${pageContext.request.contextPath }/resources/assets/admin/layout/img/avatar4.jpg" width="27px" height="27px">
												...
												<div class="todo-tasklist-item todo-tasklist-item-border-red">
													<img class="todo-userpic pull-left" src="${pageContext.request.contextPath }/resources/assets/admin/layout/img/avatar5.jpg" width="27px" height="27px">
													<div class="todo-tasklist-item-title">
												...
												<div class="todo-tasklist-item todo-tasklist-item-border-green">
													<img class="todo-userpic pull-left" src="${pageContext.request.contextPath }/resources/assets/admin/layout/img/avatar9.jpg" width="27px" height="27px">
													<div class="todo-tasklist-item-title">
														 Slider Redesign
													</div>
													<div class="todo-tasklist-controls pull-left">
												...
												<div class="todo-tasklist-item todo-tasklist-item-border-blue">
													<img class="todo-userpic pull-left" src="${pageContext.request.contextPath }/resources/assets/admin/layout/img/avatar6.jpg" width="27px" height="27px">
													<div class="todo-tasklist-item-title">
												...
												<div class="todo-tasklist-item todo-tasklist-item-border-purple">
													<img class="todo-userpic pull-left" src="${pageContext.request.contextPath }/resources/assets/admin/layout/img/avatar7.jpg" width="27px" height="27px">
													<div class="todo-tasklist-item-title">
												...
												<div class="todo-tasklist-item todo-tasklist-item-border-yellow">
													<img class="todo-userpic pull-left" src="${pageContext.request.contextPath }/resources/assets/admin/layout/img/avatar8.jpg" width="27px" height="27px">
													<div class="todo-tasklist-item-title">
														 New Search Keywords
													</div>
													<div class="todo-tasklist-item-text">
													...
													<div class="form-group">
														<div class="col-md-8 col-sm-8">
															<div class="todo-taskbody-user">
																<img class="todo-userpic pull-left" src="${pageContext.request.contextPath }/resources/assets/admin/layout/img/avatar6.jpg" width="50px" height="50px">
																...
																<div class="col-md-12">
																	<ul class="media-list">
																		<li class="media">
																			...
																			<img class="todo-userpic" src="${pageContext.request.contextPath }/resources/assets/admin/layout/img/avatar8.jpg" width="27px" height="27px">
																			</a>
																			<div class="media-body todo-comment">
																				...
																				<div class="media">
																					<a class="pull-left" href="javascript:;">
																					<img class="todo-userpic" src="${pageContext.request.contextPath }/resources/assets/admin/layout/img/avatar4.jpg" width="27px" height="27px">
																					</a>
																		...
																		<li class="media">
																			<a class="pull-left" href="javascript:;">
																			<img class="todo-userpic" src="${pageContext.request.contextPath }/resources/assets/admin/layout/img/avatar5.jpg" width="27px" height="27px">
																			</a>
																			<div class="media-body todo-comment">
																				<button type="button" class="todo-comment-btn btn btn-circle btn-default btn-xs">&nbsp; Reply &nbsp;</button>
																				<p class="todo-comment-head">
																		...
																		<li class="media">
																			<a class="pull-left" href="javascript:;">
																			<img class="todo-userpic" src="${pageContext.request.contextPath }/resources/assets/admin/layout/img/avatar6.jpg" width="27px" height="27px">
																			</a>
																			<div class="media-body todo-comment">
																				<button type="button" class="todo-comment-btn btn btn-circle btn-default btn-xs">&nbsp; Reply &nbsp;</button>
																				<p class="todo-comment-head">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/resources/assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
...
<script src="${pageContext.request.contextPath }/resources/assets/admin/pages/scripts/todo.js" type="text/javascript"></script>
