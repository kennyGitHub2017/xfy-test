...
<tiles:insertDefinition name="metronicTemplate">
	<tiles:putAttribute name="title">Eub设置</tiles:putAttribute>
		...
		<div class="portlet-body form">
				...
				<form  class="form-horizontal" id="smtform"
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">API开发者ID:</label>
							<div class="col-md-4">
								<input type="text" class="form-control" placeholder="请输入API开发者ID" name="appId" value="${eubconfig.appId}">
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label">API 签名:</label>
							<div class="col-md-4">
								<input type="text" class="form-control" placeholder="请输入API 签名" name="appSecret" value="${eubconfig.appSecret}">
							</div>
						</div>
						<div class="form-group">
