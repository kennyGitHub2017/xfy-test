...
<tiles:insertDefinition name="metronicTemplate">
	...
	<tiles:putAttribute name="page-content">
		...
		<div class="portlet-body form">
													<!-- BEGIN FORM-->
				<form  class="form-horizontal" id="ebayform"
					action="${pageContext.request.contextPath}/account/ebay/login" method="post">
					<input type="hidden" name="id" value="${id}">
					<div class="form-body">
						<div class="form-group">
							<label class="col-md-3 control-label">易贝账号:</label>
							<div class="col-md-4">
								<input type="text" class="form-control" placeholder="请输入易贝账号" name="accountName" value="${accountName}">
								<span class="help-inline">
										输入帐号，选择关联易贝按钮后，系统将会显示易贝的登陆连接，如果没有打开，请选择下方的授权连接
								 </span>
							</div>
						</div>
					</div>
