...
<c:set scope="request" var="sysPage" value="my_deposit_log" />

<c:set var="pavaTitle" value="资金流水明细" />
				...
				<div class="portlet light ">
					...
					<div class="portlet-body">
						<div class="table-toolbar">
							<div class="col-md-12">
								<h2>我的余额： <span style="color:red"> ￥ ${sellerDeposit == null ? 0 : sellerDeposit.deposit }</span></h2>
							</div>
						</div>
						<div class="table-toolbar">
