					...
					<div class="portlet-body">
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group form-group-sm">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="goodsSku" value="">
										</div>
									</div>
								</div>
								<div class="col-md-4">
						...
						<div class="table-toolbar">
							<div class="row">
								<div class="col-md-6">
									<div class="btn-group">
										<a class=" btn default" href="javascript:;" id="seller_add_goods_btn"> <spring:message code="g.label.delete" /> <i class="fa fa-trash-o"></i></a>
									</div>
								</div>
							</div>
						</div>
						
						<form id="seller_goods_select_form" action="${pageContext.request.contextPath }/seller-goods/delete">
		...
		<script type="text/javascript">
			...
			function initFun() {
				...
				$("#goods_table").dataTable({
					serverSide : true,
					ajax : {
						url : "${pageContext.request.contextPath }/seller-goods/page.json",
						type : 'post',
